...
var typed = new Typed('.bgVideo  span.type', {
  strings : [ " " , "<i class='fa fa-users'></i> Team Of Efficient Chef's and Workers.",
             " <i class='fa fa-cutlery'></i> We Provide Quality Food.",
             " <i class='fa fa-check-circle'></i> With All Safety-Measures."],
    loop:true,
    typeSpeed: 40,
    backSpeed:30
});
